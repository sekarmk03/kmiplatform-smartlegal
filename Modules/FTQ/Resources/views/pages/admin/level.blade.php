...
@push('scripts')
    ...
    <script>
        ...
        var daTable = $('#daTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('ftq.admin.level.index') }}",
            columns: [
        ...
        function edit(id){
            ...
            let editUrl = "{!! route('ftq.admin.level.edit', ':id') !!}";
            editUrl = editUrl.replace(':id', id);
            url = "{{ route('ftq.admin.level.update', ':id') }}";
        ...
        function destroy(id){
            let deleteUrl = "{{ route('ftq.admin.level.destroy', ':id') }}";
