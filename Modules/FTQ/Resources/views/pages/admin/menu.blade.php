...
@push('scripts')
    ...
    <script>
        ...
        var daTable = $('#daTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('ftq.admin.menu.index') }}",
            columns: [
        ...
        function create(){
            ...
            url = "{!! route('ftq.admin.menu.store') !!}";
            method = "POST";
        }
        function edit(id){
            $('.modal-header h4').html('Edit Menu');
            $('.modal-body form').append('<input type="hidden" name="_method" value="PUT">');
            let editUrl = "{!! route('ftq.admin.menu.edit', ':id') !!}";
            editUrl = editUrl.replace(':id', id);
            url = "{{ route('ftq.admin.menu.update', ':id') }}";
        ...
        function destroy(id){
            let deleteUrl = "{{ route('ftq.admin.menu.destroy', ':id') }}";
