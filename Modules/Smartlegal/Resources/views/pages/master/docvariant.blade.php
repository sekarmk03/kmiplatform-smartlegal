...
@section('content')
	...
	<ol class="breadcrumb float-xl-end">
		...
		<li class="breadcrumb-item active">Document Variants</li>
	</ol>
	<!-- END breadcrumb -->
	<!-- BEGIN page-header -->
	<h1 class="page-header">Document Variants</h1>
	<!-- END page-header -->
    <div class="row">
        <div class="col-12 ui-sortable">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title">Document Variant Table</h4>
                    <div class="me-3">
    ...
    <div class="modal fade" id="modal-level">
        ...
        <div class="modal-content">
            ...
            <form action="" method="post">
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="VariantDesc">Variant Description</label>
                        <textarea name="txtDesc" id="VariantDesc" cols="30" rows="5" class="form-control" placeholder="Enter variant description.."></textarea>
                    </div>
            </div>
...
@push('scripts')
    ...
    <script>
        ...
        let daTable = $('#daTable').DataTable({
            ...
            autoWidth: true,
            responsive: true,
            ajax: "{{ route('smartlegal.master.docvariant.index') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex', className: 'text-center'},
                {data: 'dtmCreatedAt', name: 'dtmCreatedAt', className: 'text-center'},
                {data: 'txtVariantName', name: 'txtVariantName', className: 'text-center'},
                {
                    data: 'txtDesc',
                    name: 'txtDesc',
                    width: '60%'
        ...
        const edit = ( id ) => {
            ...
            $.get(editUrl, (response) => {
                $('#modal-level').modal('show');
                $('input#VariantName').val(response.data.txtVariantName);
                $('textarea#VariantDesc').val(response.data.txtDesc);
            });
        }
        ...
        const destroy = (id) => {
            let deleteUrl = "{{ route('smartlegal.master.docvariant.destroy', ':id') }}";
        ...
        $(document).ready(() => {
            ...
            $('#modal-level').on('hide.bs.modal', () => {
                $('input#VariantName').val('');
                $('textarea#VariantDesc').val('');
