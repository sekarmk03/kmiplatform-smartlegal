...
@push('scripts')
    ...
    <script>
        ...
        var daTable = $('#daTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('rois.access-control.index') }}",
            columns: [
        ...
        function edit(id){
            ...
            let userUrl = "{{ route('rois.access-control.users', ':id') }}";
            ...
            $.get(userUrl, function(response){
                ...
                let editUrl = "{!! route('rois.access-control.edit', ':id') !!}";
                editUrl = editUrl.replace(':id', id);
                url = "{{ route('rois.access-control.update', ':id') }}";
