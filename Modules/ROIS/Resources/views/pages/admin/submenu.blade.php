...
@push('scripts')
    ...
    <script>
        ...
        function getMenuList(id = false){
            ...
            let option = '';
            wrapper.empty();
            $.get("{{ route('rois.menu.list') }}", function(response){
        ...
        function edit(id){
            ...
            let editUrl = "{!! route('rois.submenu.edit', ':id') !!}";
            editUrl = editUrl.replace(':id', id);
            url = "{{ route('rois.submenu.update', ':id') }}";
        ...
        function destroy(id){
            let deleteUrl = "{{ route('rois.submenu.destroy', ':id') }}";
