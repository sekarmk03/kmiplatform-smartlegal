...
<div id="sidebar" class="app-sidebar {{ $appSidebarClass }}">
	...
	<div class="app-sidebar-content" data-scrollbar="true" data-height="100%">
		<div class="menu">
			...
			@php
				$user = Modules\ROIS\Entities\TrUser::where('user_id', Auth::user()->id)->first();
				$menus = Modules\ROIS\Entities\Menu::with('submenu')
					->whereIn('intMenu_ID', Modules\ROIS\Entities\LevelMenu::where('intLevel_ID', $user->intLevel_ID)->get(['intMenu_ID'])->toArray())
