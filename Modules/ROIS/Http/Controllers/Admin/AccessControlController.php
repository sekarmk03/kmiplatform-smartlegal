...
use App\Models\User;
use Modules\ROIS\Entities\Mlevel as level;
use Modules\ROIS\Entities\TrUser;
use Modules\ROIS\Entities\Menu;
use Modules\ROIS\Entities\LevelMenu;
...
class AccessControlController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        if ($level) {
            return response()->json([
                'status' => 'success',
                'message' => 'Access Level successfully Deleted'
            ], 200);
        } else {
            return response()->json([
                'status' => 'error',
                'message' => 'Access Level not Exist'
            ], 404);
        }
