...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        var daTable = $('#daTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('roonline.device.index')); ?>",
            columns: [
        ...
        function create(){
            ...
            url = "<?php echo e(route('roonline.device.store')); ?>";
            method = "POST";
        }
        function edit(id){
            $('.modal-header h4').html('Edit Device');
            $('.modal-body form').append('<input type="hidden" name="_method" value="PUT">');
            let editUrl = "<?php echo route('roonline.device.edit', ':id'); ?>";
            editUrl = editUrl.replace(':id', id);
            url = "<?php echo e(route('roonline.device.update', ':id')); ?>";
        ...
        function destroy(id){
            let deleteUrl = "<?php echo e(route('roonline.device.destroy', ':id')); ?>";
